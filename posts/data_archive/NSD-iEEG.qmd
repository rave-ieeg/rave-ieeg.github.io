...
for (subject_code in subjects) {
  rave_subject <- ravecore::new_rave_subject(
    project_name = "NSDiEEG", 
    subject_code = sprintf("NSDiEEG_%s", subject_code)
  ) 
  brain <- ravecore::rave_brain(rave_subject, surfaces = c("sphere.reg"))
...
template_brain <- threeBrain::merge_brain(
  .list = brain_list, template_subject = template, 
