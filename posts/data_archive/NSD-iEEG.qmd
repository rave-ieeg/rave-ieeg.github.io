...
The Natural Scenes Dataset (NSD) is a large-scale fMRI dataset conducted at ultra-high-field (7T) strength at the Center of Magnetic Resonance Research (CMRR) at the University of Minnesota (https://naturalscenesdataset.org). A recent work has presented the NSD stimuli to intracranial EEG patients. Here is how you can visualize the NSD-iEEG dataset with RAVE.
