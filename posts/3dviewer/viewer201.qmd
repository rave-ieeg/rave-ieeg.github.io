...
webr:
  packages: ['raveio']
  repos: ['https://rave-ieeg.r-universe.dev', 'https://dipterix.r-universe.dev', 'https://repo.r-wasm.org/']
  version: 0.4.2
...
Once the script is ready, you will see "WEBR STATUS: 🟢 Ready!" in the above banner. 
