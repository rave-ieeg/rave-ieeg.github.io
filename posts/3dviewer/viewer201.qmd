...
# Load profile
.ensure_subject("demo/DemoSubject")
dir.create("data/tables", showWarnings = FALSE, recursive = TRUE)
utils::write.csv(
  data.frame(
    Subject = "DemoSubject",
    Electrode = 1:84,
  ...
  "data/tables/viewer201_value_table.csv"
)
```
...
Library `ravecore` provides simple high-level function [`rave_brain`](#function-rave_brain) to load 3D brain object.
...
### Function `ravecore::rave_brain` {#function-rave_brain}
